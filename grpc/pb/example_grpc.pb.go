...
func (c *greeterClient) SimpleRPC(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Greeter/SimpleRPC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) ServerSideStreamingRPC(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_ServerSideStreamingRPCClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/Greeter/ServerSideStreamingRPC", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) ClientSideStreamingRPC(ctx context.Context, opts ...grpc.CallOption) (Greeter_ClientSideStreamingRPCClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], "/Greeter/ClientSideStreamingRPC", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) BidrectionalStreamingRPC(ctx context.Context, opts ...grpc.CallOption) (Greeter_BidrectionalStreamingRPCClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/Greeter/BidrectionalStreamingRPC", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterBidrectionalStreamingRPCClient) CloseAndRecv() (*HelloResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(HelloResponse)
...
func (x *greeterBidrectionalStreamingRPCServer) SendAndClose(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}
